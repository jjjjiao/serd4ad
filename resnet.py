...
def _resnet(
    ...
    **kwargs: Any
    ...
    if pretrained:
        ...
        #        state_dict.pop(k)
        # "layer1.0.SE.fc.0.weight", "layer1.0.SE.fc.2.weight", "layer1.1.SE.fc.0.weight", "layer1.1.SE.fc.2.weight", "layer1.2.SE.fc.0.weight", "layer1.2.SE.fc.2.weight", "layer2.0.SE.fc.0.weight", "layer2.0.SE.fc.2.weight", "layer2.1.SE.fc.0.weight", "layer2.1.SE.fc.2.weight", "layer2.2.SE.fc.0.weight", "layer2.2.SE.fc.2.weight", "layer2.3.SE.fc.0.weight", "layer2.3.SE.fc.2.weight", "layer3.0.SE.fc.0.weight", "layer3.0.SE.fc.2.weight", "layer3.1.SE.fc.0.weight", "layer3.1.SE.fc.2.weight", "layer3.2.SE.fc.0.weight", "layer3.2.SE.fc.2.weight", "layer3.3.SE.fc.0.weight", "layer3.3.SE.fc.2.weight", "layer3.4.SE.fc.0.weight", "layer3.4.SE.fc.2.weight", "layer3.5.SE.fc.0.weight", "layer3.5.SE.fc.2.weight", "layer4.0.SE.fc.0.weight", "layer4.0.SE.fc.2.weight", "layer4.1.SE.fc.0.weight", "layer4.1.SE.fc.2.weight", "layer4.2.SE.fc.0.weight", "layer4.2.SE.fc.2.weight"
        # del state_dict["layer1.0.SE.fc.0.weight", "layer1.0.SE.fc.2.weight", "layer1.1.SE.fc.0.weight", "layer1.1.SE.fc.2.weight", "layer1.2.SE.fc.0.weight", "layer1.2.SE.fc.2.weight", "layer2.0.SE.fc.0.weight", "layer2.0.SE.fc.2.weight", "layer2.1.SE.fc.0.weight", "layer2.1.SE.fc.2.weight", "layer2.2.SE.fc.0.weight", "layer2.2.SE.fc.2.weight", "layer2.3.SE.fc.0.weight", "layer2.3.SE.fc.2.weight", "layer3.0.SE.fc.0.weight", "layer3.0.SE.fc.2.weight", "layer3.1.SE.fc.0.weight", "layer3.1.SE.fc.2.weight", "layer3.2.SE.fc.0.weight", "layer3.2.SE.fc.2.weight", "layer3.3.SE.fc.0.weight", "layer3.3.SE.fc.2.weight", "layer3.4.SE.fc.0.weight", "layer3.4.SE.fc.2.weight", "layer3.5.SE.fc.0.weight", "layer3.5.SE.fc.2.weight", "layer4.0.SE.fc.0.weight", "layer4.0.SE.fc.2.weight", "layer4.1.SE.fc.0.weight", "layer4.1.SE.fc.2.weight", "layer4.2.SE.fc.0.weight", "layer4.2.SE.fc.2.weight"]
        # model.load_state_dict(state_dict)

        import numpy as np
        model_dict = model.state_dict()         # 部分不使用预训练权重
...
# model, bn = wide_resnet50_2()
# # model2 = de_wide_resnet50_2()
# # net = nn.Sequential(model, bn, model2)
# net = nn.Sequential(model, bn)
